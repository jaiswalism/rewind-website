      ...
      <main className="max-w-4xl mx-auto px-6 relative z-10 pb-32">
        <div className="bg-white/60 backdrop-blur-3xl rounded-[3rem] p-10 md:p-16 shadow-[0_20px_60px_-15px_rgba(34,60,51,0.05)] border border-white">
          ...
          <div className="prose prose-lg prose-headings:text-[var(--foreground)] text-[var(--foreground)] opacity-80 max-w-none">
            ...
            <p className="mb-4">You must be at least 18 years old to use Rewind. When you use Rewind, we process data necessary to provide our core features:</p>
            ...
            <p className="mb-4">Rewind utilizes advanced AI models to power the Live Voice virtual companion. When you speak to your companion, your audio is processed in real-time to generate low-latency responses. We do not use your personal voice data to train our core AI models, and conversational transcripts are securely tied to your private account unless you explicitly choose to share them.</p>
            
            <h2 className="text-2xl font-bold mt-8 mb-4">3. Data Security & Storage</h2>
            <p className="mb-4">All private journal entries, uploaded media, and personalized settings are stored securely using industry-standard database infrastructure. We implement strict <strong>Row Level Security (RLS)</strong> over our secure database architecture, ensuring that cryptographically, only your authenticated device can access or retrieve your private, non-community datasets.</p>
